...
//
// [DA COMPLETARE] segnala i dati che servono all'utente: nessun dato legale è
// stato inventato.
//
...
export const CONTENT = {
  it: {
    ...
    example: {
      ...
      letterHighlight: 'Vi invitiamo a trasmettere il rendiconto entro il 31 agosto 2026.',
      ...
      when: 'Entro il 31.08.2026 · Mancano 12 giorni',
      quoteLabel: 'Mostra nel documento',
      quote: 'Vi invitiamo a trasmettere il rendiconto entro il 31 agosto 2026.',
    ...
    aboutRole: '[DA COMPLETARE: ruolo — es. fondatore e sviluppatore]',
    aboutPlace: '[DA COMPLETARE: sede — comune e cantone]',
    aboutWhy:
    ...
    contactAddress: '[DA COMPLETARE: indirizzo]',
    ...
    legal: {
      ...
      updated: 'Ultimo aggiornamento: [DA COMPLETARE: data]',
      impressum: {
        title: 'Impressum',
        intro: 'Indicazioni sul gestore di questo sito e del servizio AI-Swisse.',
        sections: [
          { h: 'Titolare del servizio', p: ['[DA COMPLETARE: ragione sociale]', '[DA COMPLETARE: forma giuridica — ditta individuale, Sagl, SA]', '[DA COMPLETARE: indirizzo completo]', '[DA COMPLETARE: numero IDI/CHE, se iscritto al registro di commercio]'] },
          { h: 'Contatto', p: [`Email: ${CONTACT_EMAIL}`, '[DA COMPLETARE: telefono, se se ne vuole pubblicare uno]'] },
          { h: 'Responsabile dei contenuti', p: ['Andrea Cavalieri', '[DA COMPLETARE: indirizzo, se diverso da quello del titolare]'] },
      ...
      privacy: {
        ...
        sections: [
          { h: 'Chi tratta i dati', p: ['[DA COMPLETARE: ragione sociale e indirizzo del titolare del trattamento]', `Contatto per le questioni sui dati: ${CONTACT_EMAIL}`, '[DA COMPLETARE: eventuale rappresentante nell’UE ai sensi dell’art. 27 GDPR, se necessario]'] },
          { h: 'Questo sito', p: ['La vetrina che state leggendo non usa cookie, non ha strumenti di analisi statistica e non carica risorse da altri siti: nessun carattere tipografico remoto, nessun tracciamento. Il server registra le richieste secondo la prassi ordinaria del fornitore di hosting.', '[DA COMPLETARE: nome del fornitore di hosting del sito vetrina, una volta scelto]'] },
      ...
      terms: {
        ...
        intro: 'Le regole del rapporto fra chi usa AI-Swisse e chi lo gestisce. [DA COMPLETARE: da far rivedere a un legale prima della messa online.]',
        sections: [
          ...
          { h: 'Disponibilità', p: ['Ci impegniamo a mantenere il servizio disponibile, senza garantire un funzionamento ininterrotto. Interventi di manutenzione e guasti dei fornitori possono causare interruzioni.', '[DA COMPLETARE: eventuale livello di servizio garantito.]'] },
          { h: 'Prezzi e pagamento', p: ['Le condizioni economiche sono concordate individualmente nella fase attuale, con le imprese pilota. [DA COMPLETARE: listino, periodicità di fatturazione, modalità di pagamento, durata e disdetta.]'] },
          { h: 'Responsabilità', p: ['[DA COMPLETARE: clausola di limitazione della responsabilità, da redigere con un legale nel rispetto del diritto svizzero.]'] },
          { h: 'Diritto applicabile e foro', p: ['[DA COMPLETARE: diritto svizzero e foro competente — indicare la sede.]'] },
        ],
      },
    },
  },
  ...
  de: {
    ...
    example: {
      ...
      letterHighlight: 'Wir bitten Sie, die Abrechnung bis zum 31. August 2026 einzureichen.',
      ...
      when: 'Bis 31.08.2026 · 12 Tage verbleibend',
      quoteLabel: 'Im Dokument anzeigen',
      quote: 'Wir bitten Sie, die Abrechnung bis zum 31. August 2026 einzureichen.',
    ...
    aboutName: 'Andrea Cavalieri',
    aboutRole: '[DA COMPLETARE: Funktion — z. B. Gründer und Entwickler]',
    aboutPlace: '[DA COMPLETARE: Standort — Gemeinde und Kanton]',
    aboutWhy:
    ...
    contactAddress: '[DA COMPLETARE: Adresse]',
    ...
    legal: {
      ...
      updated: 'Letzte Aktualisierung: [DA COMPLETARE: Datum]',
      impressum: {
        title: 'Impressum',
        intro: 'Angaben zum Betreiber dieser Website und des Dienstes AI-Swisse.',
        sections: [
          { h: 'Anbieter des Dienstes', p: ['[DA COMPLETARE: Firmenbezeichnung]', '[DA COMPLETARE: Rechtsform — Einzelfirma, GmbH, AG]', '[DA COMPLETARE: vollständige Adresse]', '[DA COMPLETARE: UID/CHE-Nummer, sofern im Handelsregister eingetragen]'] },
          { h: 'Kontakt', p: [`E-Mail: ${CONTACT_EMAIL}`, '[DA COMPLETARE: Telefonnummer, falls eine veröffentlicht werden soll]'] },
          { h: 'Verantwortlich für den Inhalt', p: ['Andrea Cavalieri', '[DA COMPLETARE: Adresse, falls abweichend]'] },
      ...
      privacy: {
        ...
        sections: [
          { h: 'Wer die Daten bearbeitet', p: ['[DA COMPLETARE: Firmenbezeichnung und Adresse des Verantwortlichen]', `Kontakt für Datenschutzfragen: ${CONTACT_EMAIL}`, '[DA COMPLETARE: allfälliger Vertreter in der EU nach Art. 27 DSGVO, sofern erforderlich]'] },
          { h: 'Diese Website', p: ['Die Website, die Sie gerade lesen, verwendet keine Cookies, keine Analysewerkzeuge und lädt keine Ressourcen von anderen Servern: keine externen Schriften, kein Tracking. Der Server protokolliert die Zugriffe im üblichen Rahmen des Hosting-Anbieters.', '[DA COMPLETARE: Name des Hosting-Anbieters der Website, sobald gewählt]'] },
      ...
      terms: {
        ...
        intro: 'Die Regeln zwischen denen, die AI-Swisse nutzen, und denen, die es betreiben. [DA COMPLETARE: vor der Aufschaltung juristisch prüfen lassen.]',
        sections: [
          ...
          { h: 'Verfügbarkeit', p: ['Wir bemühen uns um einen verfügbaren Dienst, ohne unterbruchsfreien Betrieb zu garantieren. Wartungsarbeiten und Ausfälle von Anbietern können zu Unterbrüchen führen.', '[DA COMPLETARE: allfällig zugesichertes Service-Level.]'] },
          { h: 'Preise und Zahlung', p: ['Die wirtschaftlichen Bedingungen werden in der jetzigen Phase individuell mit den Pilotunternehmen vereinbart. [DA COMPLETARE: Preisliste, Abrechnungsperiode, Zahlungsmittel, Laufzeit und Kündigung.]'] },
          { h: 'Haftung', p: ['[DA COMPLETARE: Haftungsbeschränkung, mit einer Juristin oder einem Juristen nach schweizerischem Recht zu verfassen.]'] },
          { h: 'Anwendbares Recht und Gerichtsstand', p: ['[DA COMPLETARE: schweizerisches Recht und Gerichtsstand — Sitz angeben.]'] },
        ],
      },
    },
  },
  ...
  fr: {
    ...
    example: {
      ...
      letterHighlight: 'Nous vous invitons à transmettre le décompte avant le 31 août 2026.',
      ...
      when: 'Avant le 31.08.2026 · Dans 12 jours',
      quoteLabel: 'Afficher dans le document',
      quote: 'Nous vous invitons à transmettre le décompte avant le 31 août 2026.',
    ...
    aboutName: 'Andrea Cavalieri',
    aboutRole: '[DA COMPLETARE: fonction — p. ex. fondateur et développeur]',
    aboutPlace: '[DA COMPLETARE: localité — commune et canton]',
    aboutWhy:
    ...
    legal: {
      ...
      updated: 'Dernière mise à jour : [DA COMPLETARE: date]',
      impressum: {
        title: 'Impressum',
        intro: 'Informations sur l’exploitant de ce site et du service AI-Swisse.',
        sections: [
          { h: 'Fournisseur du service', p: ['[DA COMPLETARE: raison sociale]', '[DA COMPLETARE: forme juridique — raison individuelle, Sàrl, SA]', '[DA COMPLETARE: adresse complète]', '[DA COMPLETARE: numéro IDE/CHE, si inscrit au registre du commerce]'] },
          { h: 'Contact', p: [`E-mail : ${CONTACT_EMAIL}`, '[DA COMPLETARE: téléphone, si un numéro doit être publié]'] },
          { h: 'Responsable du contenu', p: ['Andrea Cavalieri', '[DA COMPLETARE: adresse, si différente]'] },
      ...
      privacy: {
        ...
        sections: [
          { h: 'Qui traite les données', p: ['[DA COMPLETARE: raison sociale et adresse du responsable du traitement]', `Contact pour les questions de protection des données : ${CONTACT_EMAIL}`, '[DA COMPLETARE: représentant éventuel dans l’UE au sens de l’art. 27 RGPD, si nécessaire]'] },
          { h: 'Ce site', p: ['Le site vitrine que vous lisez n’utilise pas de cookies, n’a pas d’outil de mesure d’audience et ne charge aucune ressource depuis un autre serveur : pas de police distante, pas de traçage. Le serveur journalise les requêtes selon la pratique ordinaire de l’hébergeur.', '[DA COMPLETARE: nom de l’hébergeur du site vitrine, une fois choisi]'] },
      ...
      terms: {
        ...
        intro: 'Les règles entre celles et ceux qui utilisent AI-Swisse et celui qui l’exploite. [DA COMPLETARE: à faire relire par un juriste avant la mise en ligne.]',
        sections: [
          ...
          { h: 'Disponibilité', p: ['Nous nous efforçons de maintenir le service disponible, sans garantir un fonctionnement ininterrompu. Maintenances et pannes de fournisseurs peuvent provoquer des interruptions.', '[DA COMPLETARE: niveau de service éventuellement garanti.]'] },
          { h: 'Tarifs et paiement', p: ['Les conditions économiques sont convenues individuellement dans la phase actuelle, avec les entreprises pilotes. [DA COMPLETARE: grille tarifaire, périodicité de facturation, moyens de paiement, durée et résiliation.]'] },
          { h: 'Responsabilité', p: ['[DA COMPLETARE: clause de limitation de responsabilité, à rédiger avec un juriste selon le droit suisse.]'] },
          { h: 'Droit applicable et for', p: ['[DA COMPLETARE: droit suisse et for compétent — indiquer le siège.]'] },
        ],
      },
    },
  },
