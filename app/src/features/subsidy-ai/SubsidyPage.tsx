...
export function SubsidyPage() {
  ...
  const matches = useMemo(
    () => matchPrograms(buildMatchProfile(activeCompany, companyProfile)),
    ...
    <>
      <div className="page-head">
        ...
        <div className="page-desc">
          ...
          Rilevanza e idoneità sono due cose distinte. Copertura demo: Confederazione + Cantone Ticino.
        </div>
      </div>
      ...
      {tab === 'profile' && <ProfileForm onSaved={() => { setTab('results'); setSelectedProgramId(null); }} />}
      ...
      <div className="footnote">
        <strong>Dati dimostrativi — verificare la fonte ufficiale.</strong> Il database di programmi è a scopo di prototipo.
        La «Rilevanza» misura la pertinenza al progetto, non la probabilità di ottenere il contributo; l’«Idoneità» è una stima
        basata sulle tue risposte e non sostituisce la valutazione dell’ente. Importi, requisiti e scadenze vanno sempre confermati sulla fonte ufficiale.
      </div>
    </>
  );
}
