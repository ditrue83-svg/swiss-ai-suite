...
| **Finanze** | Fatture fornitori, ricevute e note di credito, e fatture emesse verso i clienti con polizza QR svizzera e registro delle scadenze: comprendere e preparare il denaro, non muoverlo. Nessun pagamento, nessun file di pagamento, nessuna scrittura contabile — un IBAN si mostra, non si esegue, e «pagata» la dichiara una persona con la data effettiva. |
...
| **Clienti** | Con chi l'azienda sta lavorando: clienti, prospect, fornitori, partner, enti — e tutto il lavoro collegato attorno a ognuno. Collega, non copia: il nome del fornitore letto su una fattura resta di Finanze, la controparte letta su un contratto resta dei Contratti, il mittente resta dell'Inbox. Nessuna anagrafica nasce da sola: le corrispondenze si propongono, non si applicano. Include email CRM umane e preventivi PDF versionati collegati alle trattative. |
| **Oggi** | La home da mobilità: che cosa scade oggi, quale trattativa aspetta un prossimo passo — che si scrive da lì —, il numero per chiamare il cliente e la nota rapida, anche dettata. Non è una seconda Panoramica: niente KPI, è la lista delle cose da fare adesso. |
